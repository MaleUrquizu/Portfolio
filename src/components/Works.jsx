  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Los proyectos a continuación ilustran mis habilidades y experiencia a través de ejemplos concretos de mi trabajo.
          Cada proyecto se describe brevemente con
      ...
      <div className='mt-20 flex flex-wrap justify-center gap-6 max-w-screen-lg mx-auto'>
